...
async function openQuoteModal(queryId, existingQuoteId){
  ...
  var route=query.trip_type==='multi'?'Multiple sectors':escapeHtml(query.departure||'ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ')+'  &#8594;  '+escapeHtml(query.destination||'ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ');
